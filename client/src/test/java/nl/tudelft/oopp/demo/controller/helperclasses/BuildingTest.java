...
public class BuildingTest {
    ...
    public void save() {
        ...
        b2 = new Building("name2", "streetName2", "streetNumber2", "zipCode2", "city2");
        b3 = new Building("name3", "streetName3", "streetNumber3", "zipCode3", "city3");
        b1.setId(1L);
        b2.setId(2L);
        b3.setId(3L);
    }
    ...
    public void testEquals() {
        Building b1Equals = new Building("name1", "streetName1", "streetNumber1", "zipCode1", "city1");
