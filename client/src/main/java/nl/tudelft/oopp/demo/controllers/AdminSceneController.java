...
public class AdminSceneController implements Initializable {
    ...
    public static final TitledPane suppliesTP = new TitledPane("Supplies", new Button("View"));
    ...
    static final Button updateButtonSupplies = new Button("Update");
    static final Button deleteButtonSupplies = new Button("Delete");
    ...
    private static final TableView<Supply> tableSupplies = new TableView<>();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ac.getPanes().addAll(buildingTP, roomsTP, restaurantsTP, suppliesTP);
    }
    ...
    /**
     * The method below is implemented for the supply table which is loaded on the main accordion element in
     * the admin scene.
     */
    public static void supplyView() {
        //clearing any previous tableView to avoid multiplication
        ...
        // HBox for the buttons under the table
        HBox hoBoxAddDeleteUpdateSupplies = new HBox(10);
        hoBoxAddDeleteUpdateSupplies.setPadding(new Insets(20, 20, 20, 0));
        hoBoxAddDeleteUpdateSupplies.getChildren().setAll(deleteButtonSupplies, updateButtonSupplies);

        // This VBox contains the table for the rooms and adding a room
        HBox hoBoxSuppliesTP = new HBox();
        hoBoxSuppliesTP.setSpacing(100);
        ...
        suppliesTP.setContent(scrollPaneRestaurant);
    }
}
