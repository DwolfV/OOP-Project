    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/building/**", "/equipment/**", "/holidays/**",
                        ...
                        "/room_reservations/**", "/supply/**", "/login", "/room_reservations_times/**", "/occasion/**", "/friend/**")
                        .hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.GET, "/users/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/room_reservations/**", "/friend/**").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.PUT, "/room_reservations/**").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.DELETE, "/room_reservations/**", "/friend/**").hasAnyRole("USER", "ADMIN")
